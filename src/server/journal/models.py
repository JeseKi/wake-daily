...
class JournalAwarenessSession(Base):
    ...
    user_id: Mapped[int] = mapped_column(Integer, nullable=False, index=True)
    class_id: Mapped[int] = mapped_column(Integer, nullable=False, index=True)
    entry_mode: Mapped[str] = mapped_column(String(32), nullable=False, default="awareness_v1")
    free_content: Mapped[str | None] = mapped_column(Text, default=None)
    ...
    analysis_marks_json: Mapped[str] = mapped_column(Text, nullable=False, default="[]")
    inquiry_records_json: Mapped[str] = mapped_column(Text, nullable=False, default="[]")
